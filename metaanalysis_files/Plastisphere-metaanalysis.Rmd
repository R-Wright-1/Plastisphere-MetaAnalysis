...
Please see the [Github repository](https://github.com/R-Wright-1/Plastisphere-MetaAnalysis) for more details.
...
<br/>
If you are adding a study then you should add details of this (following the existing formats) to the files in the ['metaanalysis_files' folder](https://github.com/R-Wright-1/Plastisphere-MetaAnalysis/tree/master/metaanalysis_files):<br/>
<ul>
...
<ul>
<li>[The raw reads files in QIIME2 .qza format](https://doi.org/10.6084/m9.figshare.12931372)</li>
...
If you have downloaded the raw study reads then these are already imported to the QIIME2 format, so you can simply start from (III) (making sure that you change the file name and primer sequences appropriately - primer sequences can be found in Supplementary Table S1B).
...
These can be found [here](https://github.com/R-Wright-1/Plastisphere-MetaAnalysis/tree/master/files_needed) as well as in both directories in [this Figshare file](https://doi.org/10.6084/m9.figshare.12227303):
<ul>
<li>metadata.txt</li>
<li>Study_dates.csv</li>
<li>Study_location.csv</li>
...
This goes through all analyses run, but you can download all of the analysis files used and created from [this Figshare file](https://doi.org/10.6084/m9.figshare.12227303) (in the paper_data folder). In particular, taking the random_forest and ancom files will make a very big difference to how long this takes to run. If you just want to re-make the figures (possibly with changes) then you can add all files but remove the figures folder.

It is expected that the base directory contains, at a minimum (as in the example_minimum_directory at [this Figshare file](https://doi.org/10.6084/m9.figshare.12227303)):
<ul>
<li>metadata.txt</li>
<li>Study_dates.csv</li>
<li>Study_location.csv</li>
...
![](/Users/robynwright/Documents/OneDrive/Papers_writing/Plastisphere_Meta-analysis/test_recreate_analyses/paper_data/figures/Fig1_map_metrics.png)
...
![](/Users/robynwright/Documents/OneDrive/Papers_writing/Plastisphere_Meta-analysis/test_recreate_analyses/paper_data/figures/FigS1_richness.png)
...
![](/Users/robynwright/Documents/OneDrive/Papers_writing/Plastisphere_Meta-analysis/test_recreate_analyses/paper_data/figures/Fig2_nmds_overall_rare.png)
...
![](/Users/robynwright/Documents/OneDrive/Papers_writing/Plastisphere_Meta-analysis/test_recreate_analyses/paper_data/figures/Fig3_heatmap_combined_rare.png)
...
![](/Users/robynwright/Documents/OneDrive/Papers_writing/Plastisphere_Meta-analysis/test_recreate_analyses/paper_data/figures/Fig4_dendro_venn_rare.png)
...
![](/Users/robynwright/Documents/OneDrive/Papers_writing/Plastisphere_Meta-analysis/test_recreate_analyses/paper_data/figures/FigS2_RF_compare.png)
...
![](/Users/robynwright/Documents/OneDrive/Papers_writing/Plastisphere_Meta-analysis/test_recreate_analyses/paper_data/figures/FigS3_RF_env_compare.png)
...
![](/Users/robynwright/Documents/OneDrive/Papers_writing/Plastisphere_Meta-analysis/test_recreate_analyses/paper_data/figures/Fig5_random_forest_rare.png)
...
```{python, get_rf_plots_separate, results='hide', fig.keep='all', message=FALSE, cache=TRUE}
...
![](/Users/robynwright/Documents/OneDrive/Papers_writing/Plastisphere_Meta-analysis/test_recreate_analyses/paper_data/figures/FigS4_rare_ASV_accuracy.png)
...
And now plot those figures:

#### Feature importance > 0.005
![](/Users/robynwright/Documents/OneDrive/Papers_writing/Plastisphere_Meta-analysis/test_recreate_analyses/paper_data/figures/FigS5_environment_random_forest_0.005_rare.png)
This is shown in [Supplementary Section 3](https://doi.org/10.6084/m9.figshare.12233759).

#### Feature importance > 0.01
![](/Users/robynwright/Documents/OneDrive/Papers_writing/Plastisphere_Meta-analysis/test_recreate_analyses/paper_data/figures/FigS5_environment_random_forest_0.01_rare.png)
This is shown as Figure S5.
...
Colorbar:
![](/Users/robynwright/Documents/OneDrive/Papers_writing/Plastisphere_Meta-analysis/test_recreate_analyses/paper_data/figures/colorbars.png)
...
![](/Users/robynwright/Documents/OneDrive/Papers_writing/Plastisphere_Meta-analysis/ISME/Review 1/Figures/Fig6_metacoder_rare.png)
